...
- **Founding members (a race, not a list):** doors open to the **insider waitlist on November 1**, a month before the public — only insider-waitlist emails can create an account and pay in that month. From November 1, **the first 25 people who pay become the founding members**, and the window closes **November 15** — whichever comes first, 25 seats or the 15th. A seat is earned by *paying* (comped and Free accounts never take one) and is granted at checkout, not at signup. Founding members get **25% off any membership tier for their first year** (Member $37.49 / Builder $112.49 / Premium $187.49 / Owner $374.99, FOUNDING25PCT — annual 25% once), their **first year of LIVE Lunch & Learns free**, a permanent founding badge, and **15% off their first three Senior Advisor retainer months** (FOUNDRET15X3, unless the larger $1,500 intake credit applies). The cap lives in `settings.founding_cap` and the close date in `settings.founding_deadline`, both changeable without a deploy. Seats remaining are exposed publicly so the site can show the race.

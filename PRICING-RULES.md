...
- **GroundUp Lifetime Pass — $5,000 one-time** (`pass_lifetime`, gold card in the passes section): every course **in perpetuity** (new ones included), **one year of Builder membership free** (auto-reverts to Free after — the daily cron handles it, never touching paid subscriptions), **group office hours for the first 5 years** at the Premium allowance, and **every Lunch & Learn — live + recordings — for life**. The ceiling is Builder: no downloads, no Opportunity Board, nothing above it.
...
- **Full Project Intake — $1,500, sold standalone.** The front door for anyone with a live deal: Dr. Merritt takes in the entire project (pro forma, capital stack, site, timeline). If the client continues into a retainer, the **$1,500 is automatically credited against the first retainer month** (coupon INTAKE1500) and the intake is marked credited. The free engagement/discovery call remains the no-cost path. **The intake fee is refundable only at the team's discretion.** If the intake session takes place and no genuine deal is presented (it was in substance a 1:1 consultation), any refund granted is reduced by **$550 — the rate of a 1:1 session with Dr. Merritt** — whether or not they framed it as deal talk. With a genuine deal, the fee stands and credits toward the retainer. Refunds before the session, or for an honest wrong purchase, stay discretionary. Stated at purchase, in the confirmation email, and in the Terms — nobody buys the intake as a discounted meeting and refunds their way out.
...
- **Founding members (a race, not a list):** doors open to the **insider waitlist on November 1**, a month before the public — only insider-waitlist emails can create an account and pay in that month. From November 1, **the first 25 people who pay become the founding members**, Insiders have all of November to claim one; on **December 1** the doors open to everyone who joined the waitlist that fall, and any seat still unclaimed is theirs — scarcity is the 25-seat cap, not a clock. A seat is earned by *paying* (comped and Free accounts never take one) and is granted at checkout, not at signup. Founding members get **25% off any membership tier for their first year** (Member $37.49 / Builder $112.49 / Premium $187.49 / Owner $374.99, FOUNDING25PCT — annual 25% once), their **first year of LIVE Lunch & Learns free**, a permanent founding badge, and **15% off their first three Senior Advisor retainer months** (FOUNDRET15X3, unless the larger $1,500 intake credit applies). The cap lives in `settings.founding_cap`; an optional hard close can be set in `settings.founding_deadline` (unset by default). Seats remaining are exposed publicly so the site can show the race.

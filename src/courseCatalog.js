// Public course catalog — titles and descriptions only. Lesson CONTENT lives in
// the database and is served by /api/resources?course= after an entitlement check;
// it must never be added back to this bundle.
export default [
  {
    "id": "mc1",

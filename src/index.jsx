          ...
          <div style={{ ...card, padding: "36px clamp(24px,4vw,44px)", marginBottom: 28, textAlign: "center" }}>
            ...
            {member ? (
              <>
                ...
                <div style={{ color: "#7a5050", fontSize: 12, fontFamily: font, marginTop: 10 }}>The year pass covers every live session for 12 months — at roughly one a quarter, that's all four for less than the price of three.</div>

  ...
  return (
    <div style={{ maxWidth: 760 }}>
      ...
      <div style={section}>
        ...
        <p style={sub}>Sends all three waitlist confirmation emails (Insider, Insider + Founding 25, and the General popup version) to an inbox of your choice, subjects marked [PREVIEW]. Nothing touches the waitlist.</p>
        <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <button disabled={busy} onClick={() => send({ kind: "waitlist_preview", to_email: meeting.to_email, to_name: "Dakotah" }, `Send the 3 waitlist welcome previews to ${meeting.to_email || "?"}?`)} style={{ ...btnRed, opacity: busy ? 0.6 : 1 }}>Send Previews</button>
        </div>
      </div>

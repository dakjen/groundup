...
function LessonRich({ text, lead }) {
  ...
  const calloutAt = lead && paraIdxs.length >= 6
    ? paraIdxs.slice(2).find(i => blocks[i].text.length > 80 && blocks[i].text.length < 240)
    : undefined;
  return (<>
    {blocks.map((b, i) => b.kind === "head" ? (
      <div key={i} style={{ fontSize: 11, color: "#b80101", fontWeight: 800, letterSpacing: "2.5px", textTransform: "uppercase", fontFamily: "'DM Sans', sans-serif", margin: "34px 0 16px", paddingTop: 22, borderTop: "1px solid #1a0000" }}>{b.text}</div>
    ) : b.kind === "list" ? (
      ...
      <blockquote key={i} style={{ margin: "30px 0", padding: "4px 0 4px 22px", borderLeft: "3px solid #b80101" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 14, flexWrap: "wrap", margin: "0 0 12px" }}>
            ...
            {!seriesGroups["The Underwriting Series"] && (
              <span title="Underwriting the Project Budget & The Closing Draw — Dr. Merritt's own method, line by line." style={{ display: "inline-flex", alignItems: "stretch", borderRadius: 3, overflow: "hidden", border: "1px solid #b8010155", whiteSpace: "nowrap", alignSelf: "center", marginLeft: "auto" }}>
                <span style={{ background: "#b80101", color: "#ffffff", fontSize: 9, fontWeight: 800, letterSpacing: "1.5px", textTransform: "uppercase", fontFamily: "'DM Sans', sans-serif", padding: "6px 10px", display: "flex", alignItems: "center" }}>Coming soon</span>
                <span style={{ background: "#150000", padding: "5px 12px", display: "flex", alignItems: "baseline", gap: 8 }}>
                  <span style={{ color: "#f0d8d8", fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontSize: 15.5 }}>The Underwriting Series</span>
                  <span style={{ color: "#8a7070", fontFamily: "'DM Sans', sans-serif", fontSize: 11.5 }}>her own method, line by line</span>
                </span>
              </span>
            )}
          </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 64 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 18 }}>
            {[
              {
                img: "/opt/hough-blue-card.jpg", name: "9410 Hough", where: "Cleveland, OH",
...
const passPlans = [
  {
    ...
    price: "$100",
    period: "one-time",
    description: "60 days of every written lesson in one course of your choice — read it all, at your pace.",
    accent: "#b80101",
    cta: "Get a Course Pass",
    features: [
      "Any 1 course of your choice",
      "60 days of full access",
      "Every written lesson in that course",
    ],
    locked: ["Worksheet, template & case-study downloads — a membership benefit", "Community access", "New courses as they're added"],
  },
  {
    ...
    features: [
      ...
      "Every written lesson, across all courses",
    ],
    locked: ["Worksheet, template & case-study downloads — a membership benefit", "Community access", "New courses as they're added"],
  },
];
...
function TermsPage() {
  ...
  return (
    <div style={S.page}><div style={S.wrap}>
      ...
      <p style={S.p}><strong style={S.strong}>Full Project Intake ($1,500):</strong> the intake fee purchases Dr. Merritt’s complete review of your project and is refundable only at our discretion. If the intake session takes place and no genuine deal is presented — the session was in substance a one-on-one consultation — any refund granted is reduced by <strong style={S.strong}>$550</strong>, the rate of a 1:1 session with Dr. Merritt. Where a genuine deal is presented, the fee stands and credits in full toward your first retainer month. Refunds requested before the session, or for a purchase made in error, remain at our discretion.</p>
            ...
            {(() => {
              ...
              return (
                <div style={{ background: "#ffffff", border: "1px solid #2a1010", borderRadius: 14, padding: "22px 24px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                  ...
                  <div style={{ fontSize: 12, color: "#9a9a9a", fontFamily: "'DM Sans', sans-serif" }}>{pct >= 100 ? "🎉 Goal hit — $150K ARR" : <><span style={{ whiteSpace: "nowrap" }}>{pct.toFixed(1)}% of the $150K goal</span>{" · "}<span style={{ whiteSpace: "nowrap" }}>{money(GOAL - arrFit)} to go</span></>}</div>
                </div>
              );
            })()}
            {statCard("Retainer leads", advisorRec, `${eliteRec} Owner · ${premiumRec} Premium`)}
          </div>
        );
      })()}
  ...
  return (
    <div style={{ maxWidth: 760 }}>
      ...
      <div style={section}>
        ...
        <p style={sub}>Sends itself <strong>7 days before the insider launch</strong> — the heads-up that starts the founding race: doors open November 1 to insiders only, and the first 25 who pay become founding members — insiders get all of November to claim a seat, and on December 1 whatever's left goes to the general waitlist. Everyone on the list gets it once; later joiners get it on the next daily run. The buttons below preview it, or send it early by hand.</p>
        <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
          <input value={meeting.to_email} onChange={e => setMeeting({ ...meeting, to_email: e.target.value })} type="email" placeholder="djmj@nreuv.com" style={{ ...inp, maxWidth: 300, marginBottom: 0 }} />
...
export default function App() {
  ...
  // First-run onboarding. Holds the pending credentials — the account is not
  // created until the flow finishes, so abandoning it leaves nothing behind.

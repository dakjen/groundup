      ...
      if (u) {
        await sendEmail(u.email, 'Your Full Project Intake is booked in',
          `<h2 style="color:#f5e8e8;font-size:22px;margin:0 0 14px;">Send it all, ${u.name.split(' ')[0]}.</h2>
           ...
           <p style="color:#7a5050;font-size:12px;line-height:1.7;">A note on the fee: the \$1,500 intake buys Dr. Merritt\u2019s full review of your project. It is refundable only at our discretion \u2014 once the review is underway or delivered, it is generally non-refundable. If you continue into a retainer, the full \$1,500 credits against your first month.</p>

  ...
  return {
    ...
    html: `
      ...
      <div style="border-left:4px solid #b80101;background:#faf7f7;border-radius:0 12px 12px 0;padding:22px 26px;margin:0 0 26px;">
        ...
        <p style="font-family:${SANS};color:#333333;font-size:14px;line-height:1.85;margin:0 0 12px;">And founding members lock in <strong style="color:#b80101;">founding pricing for their entire first year</strong> \u2014 rates that will never be offered again after launch:</p>
        <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;margin:0 0 12px;">
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Builder</td><td style="font-family:${SANS};font-size:14px;color:#b80101;font-weight:bold;padding:5px 0;">$99.99/mo for your first year</td></tr>
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Premium</td><td style="font-family:${SANS};font-size:14px;color:#b80101;font-weight:bold;padding:5px 0;">$199.99/mo for your first year</td></tr>

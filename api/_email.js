...
export function foundingThanksEmail(name, opts = {}) {
  ...
  return {
    ...
    html: `
      ...
      <a href="${siteUrl()}/about" style="display:inline-block;background:#b80101;color:#ffffff;border-radius:10px;padding:14px 32px;font-weight:bold;font-size:14px;text-decoration:none;font-family:${SANS};">Learn Dr. Gina Merritt\u2019s story \u2192</a>

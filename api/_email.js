...
export function waitlistConfirmEmail(name, founding, first10, list = 'insider') {
  ...
  const about = `
      <div style="border-top:1px solid #2a0000;margin-top:20px;padding-top:18px;">
        ...
        <p style="color:#a89080;font-size:14px;line-height:1.9;">All-access to the course library is a <strong style="color:#f0d8d8;">$250/month value on its own</strong> — included in every membership — and top-tier members get over <strong style="color:#f0d8d8;">$5,300 a year in value</strong>: advisory hours with Dr. Merritt are worth $1,650 at her going rate before you count anything else. New expertise is added every quarter.</p>
      </div>`;
  if (list === 'insider') {
    return {

  ...
  return {
    ...
    html: `
      ...
      <div style="border-left:4px solid #b80101;background:#faf7f7;border-radius:0 12px 12px 0;padding:22px 26px;margin:0 0 26px;">
        ...
        <p style="font-family:${SANS};color:#333333;font-size:14px;line-height:1.85;margin:0 0 12px;">And founding members lock in <strong style="color:#b80101;">30% off any membership for their entire first year</strong> \u2014 a rate that will never be offered again after launch:</p>
        <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;margin:0 0 12px;">
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Member</td><td style="font-family:${SANS};font-size:14px;color:#444444;padding:5px 0;"><s style="color:#999999;">$49.99</s> &nbsp;<strong style="color:#b80101;">$34.99/mo</strong> your first year</td></tr>
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Builder</td><td style="font-family:${SANS};font-size:14px;color:#444444;padding:5px 0;"><s style="color:#999999;">$149.99</s> &nbsp;<strong style="color:#b80101;">$104.99/mo</strong> your first year</td></tr>
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Premium</td><td style="font-family:${SANS};font-size:14px;color:#444444;padding:5px 0;"><s style="color:#999999;">$249.99</s> &nbsp;<strong style="color:#b80101;">$174.99/mo</strong> your first year</td></tr>
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Owner</td><td style="font-family:${SANS};font-size:14px;color:#444444;padding:5px 0;"><s style="color:#999999;">$499.99</s> &nbsp;<strong style="color:#b80101;">$349.99/mo</strong> your first year</td></tr>
          <tr><td colspan="2" style="font-family:${SANS};font-size:13px;color:#444444;padding:5px 0;">\u2026plus your <strong style="color:#161616;">first year of Lunch &amp; Learns free</strong> \u2014 and if you\u2019re headed for the Senior Advisor retainer, <strong style="color:#161616;">15% off your first retainer month</strong>.</td></tr>
        </table>

    ...
    html: `
      ...
      <div style="border-left:4px solid #b80101;background:#faf7f7;border-radius:0 12px 12px 0;padding:22px 26px;margin:0 0 26px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;margin:0 0 12px;">
          ...
          <tr><td style="font-family:${SANS};font-size:14px;color:#161616;font-weight:bold;padding:5px 12px 5px 0;white-space:nowrap;">Premium</td><td style="font-family:${SANS};font-size:14px;color:#b80101;font-weight:bold;padding:5px 0;">$149.99/mo for your first year</td></tr>
